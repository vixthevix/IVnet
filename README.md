...
Work on frontend mainly now:
    ...
    - add settings menu to configure country code. ensure mandatory to configure before starting any connection. (DONE)
    - add instruction menu ("how to set up a connection, both on IVnet and on the DS") (DONE)
    - add refresh button to nic menu (DONE)
    - add timer to connection menu (DONE)
    - add better font (DONE)
